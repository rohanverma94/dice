...
// TODO: Make it safe from failure, an stable policy would be to write the new flushes to a temporary files and then synchronize them with the main process's AOF file
// TODO: Implement merge for main process's AOF file and child process's AOF file.
